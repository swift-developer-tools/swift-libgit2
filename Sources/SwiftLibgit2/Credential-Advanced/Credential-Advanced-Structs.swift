...
/// `git_credential` is treated as an opaque struct since its function pointer is allocated and managed
/// by libgit2, and cannot be meaningfully recreated or translated.
///
/// ## C Equivalent
///
