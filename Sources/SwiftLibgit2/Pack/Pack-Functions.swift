...
///   - pb: The packbuilder to use. The underlying type must be
///   `git_packbuilder`.
///   - cb: The ``GitPackbuilderForEachCB`` callback to invoke for each
///   packed object.
...
///   `git_packbuilder`.
///   - progressCB: The ``GitPackbuilderProgressCB`` callback to invoke to
///   report packfile iteration progress.
///   - progressCBPayload: The payload to pass to `progressCB`.
/// - Returns: A ``GitErrorCode`` instance.
///
/// ## C Equivalent
