...
final class CredentialTests: XCTestCaseStopOnFail
{
    ...
    func testGitCredentialT() throws
    {
        ...
        XCTAssertEqual(GitCredentialT(cValue: GIT_CREDENTIAL_USERPASS_PLAINTEXT), .gitCredentialUserPassPlaintext)
        XCTAssertEqual(GitCredentialT(cValue: GIT_CREDENTIAL_SSH_KEY), .gitCredentialSSHKey)
        XCTAssertEqual(GitCredentialT(cValue: GIT_CREDENTIAL_SSH_CUSTOM), .gitCredentialSSHCustom)
        XCTAssertEqual(GitCredentialT(cValue: GIT_CREDENTIAL_DEFAULT), .gitCredentialDefault)
        XCTAssertEqual(GitCredentialT(cValue: GIT_CREDENTIAL_SSH_INTERACTIVE), .gitCredentialSSHInteractive)
        XCTAssertEqual(GitCredentialT(cValue: GIT_CREDENTIAL_USERNAME), .gitCredentialUsername)
        XCTAssertEqual(GitCredentialT(cValue: GIT_CREDENTIAL_SSH_MEMORY), .gitCredentialSSHMemory)
